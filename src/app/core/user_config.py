...
@dataclass(slots=True)
class AppUserConfig:
    """Настройки GUI, которые не дублируют AppDock bootstrap."""

    last_workspace_schema: str = "default"
    last_scenario_id: str = "environment_check"
...
def _coerce_config(data: dict[str, Any]) -> AppUserConfig:
    ...
    return AppUserConfig(
        ...
        last_scenario_id=str(data.get("last_scenario_id") or _DEFAULT_CONFIG.last_scenario_id),
