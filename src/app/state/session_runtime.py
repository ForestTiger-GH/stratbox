...
def _read_surface_extension_value(payload: dict[str, Any], surface_state: dict[str, Any], key: str) -> Any:
    ...
    legacy_aliases = {
        'last_operation_id': 'last_scenario_id',
        'last_operation_title': 'last_scenario_title',
        'last_operation_ok': 'last_scenario_ok',
        'last_operation_log': 'last_scenario_log',
    }
    legacy_key = legacy_aliases.get(key)
    if legacy_key and legacy_key in surface_state:
        return surface_state[legacy_key]
    if key in payload:
...
class RuntimeStateRecord:
    ...
    @property
    def last_scenario_id(self) -> str | None:  # legacy alias for boundary readers
        return self.last_operation_id

    @property
    def last_scenario_title(self) -> str | None:  # legacy alias for boundary readers
        return self.last_operation_title

    @property
    def last_scenario_ok(self) -> bool | None:  # legacy alias for boundary readers
        return self.last_operation_ok

    @property
    def last_scenario_log(self) -> str | None:  # legacy alias for boundary readers
        return self.last_operation_log
