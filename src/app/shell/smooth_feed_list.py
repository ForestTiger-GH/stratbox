...
class SmoothFeedList(QListWidget):
    """Chat-oriented list with pixel scrolling and animated wheel support.

    Trackpads already emit pixel deltas and should stay close to native behavior.
    Classic mouse wheels feel better with a short animation of the vertical
    scrollbar value instead of step-wise jumps.
    """
