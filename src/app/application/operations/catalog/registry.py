...
from app.application.operations.catalog.models import OperationSpec, OperationRegistry
from app.application.operations.forms.defaults import default_cbr_target_dir, default_escrow_target_dir
...
def build_operation_registry(context: AppContext) -> OperationRegistry:
    items = (
        OperationSpec(
            ...
            handler='app.application.operations.handlers.cbr_file_collector:run',
            group='Банк России',
            kind='business',
        ...
        OperationSpec(
            ...
            handler='app.application.operations.handlers.escrow:run',
            group='Банк России',
            kind='business',
        ...
        OperationSpec(
            ...
            handler='app.application.operations.handlers.diagnostics:run',
            group='Система',
            kind='service',
