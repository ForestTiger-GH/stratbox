...
from app.application.operations.execution.requests import OperationContext, OperationResult
...
def run_operation(spec: OperationSpec, *, context: AppContext, params: dict[str, Any] | None = None, scenario_id: str | None = None, case_id: str | None = None, step_id: str | None = None) -> OperationResult:
    ...
    try:
        ...
        from app.application.operations.execution.result_mapper import finalize_operation_result
