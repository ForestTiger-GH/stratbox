...
- **Корпоративный режим** (через плагин): работает с сетевым хранилищем, при этом пользовательский код остаётся тем же
...
## 6) Диагностика в корпоративном режиме (плагин)
